...
| Arquitetura | Requisitos de segurança e decisões de arquitetura derivados dos riscos prioritários (Etapa 3) | [docs/entrega-3/01-02-03-requisitos-de-seguranca.md](docs/entrega-3/01-02-03-requisitos-de-seguranca.md), [docs/entrega-3/05-decisoes-arquitetura.md](docs/entrega-3/05-decisoes-arquitetura.md) e diagrama de arquitetura segura | Cada requisito (RS01-RS03) está vinculado a um risco de origem e a um critério de verificação |

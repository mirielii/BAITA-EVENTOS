...
| Arquitetura | Requisitos de segurança e decisões de arquitetura derivados dos riscos prioritários (Etapa 3) | [docs/entrega-3/01-02-03-requisitos-de-seguranca.md](docs/entrega-3/01-02-03-requisitos-de-seguranca.md) e [docs/entrega-3/05-06-decisoes-e-rastreabilidade.md](docs/entrega-3/05-06-decisoes-e-rastreabilidade.md) | Cada requisito (RS01-RS03) está vinculado a um risco de origem e a um critério de verificação |
| Código | Implementação das práticas de código seguro, com testes definidos antes da implementação (Etapa 4) | [docs/entrega-4/01-contexto-e-testes-autorizacao.md](docs/entrega-4/01-contexto-e-testes-autorizacao.md), [docs/entrega-4/02-03-implementacao-e-resultados-autorizacao.md](docs/entrega-4/02-03-implementacao-e-resultados-autorizacao.md), [docs/entrega-4/04-contexto-e-testes-sessoes.md](docs/entrega-4/04-contexto-e-testes-sessoes.md) e [docs/entrega-4/05-06-implementacao-e-resultados-sessoes.md](docs/entrega-4/05-06-implementacao-e-resultados-sessoes.md) | Os testes de segurança (casos válido e malicioso) estão definidos e o resultado esperado é seguro |
